# Panel creator
A utility to generate front panels for your DIY projects (which can also be used as drilling templates). It can create small-medium panel sizes as the panel must fit in an A4 paper.
